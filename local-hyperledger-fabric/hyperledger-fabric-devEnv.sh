...
# export CORE_PEER_TLS_ROOTCERT_FILE=$FABRIC_TESTNET_HOME/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
# export CORE_PEER_MSPCONFIGPATH=$FABRIC_TESTNET_HOME/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
